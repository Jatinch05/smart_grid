...
ca_cert_path = "path to your certificate"
...
client.tls_set(ca_certs="path to your certificate")  # Ensure the path to your root CA certificate file is correct
